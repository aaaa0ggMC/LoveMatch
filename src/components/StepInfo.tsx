...
const phaseBadge: Partial<Record<StepType, { label: string; color: string; bg: string }>> = {
  ...
  find_max: { label: 'PRE-PROCESSING', color: '#0369a1', bg: '#e0f2fe' },
  build_cost: { label: 'PRE-PROCESSING', color: '#0369a1', bg: '#e0f2fe' },
  scan_row_min: { label: 'ROW REDUCTION', color: '#7c3aed', bg: '#ede9fe' },
  reduce_row: { label: 'ROW REDUCTION', color: '#7c3aed', bg: '#ede9fe' },
  scan_col_min: { label: 'COL REDUCTION', color: '#7c3aed', bg: '#ede9fe' },
  reduce_col: { label: 'COL REDUCTION', color: '#7c3aed', bg: '#ede9fe' },
